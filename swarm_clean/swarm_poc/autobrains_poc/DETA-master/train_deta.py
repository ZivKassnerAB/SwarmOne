...
def get_args_parser():
    ...
    parser.add_argument('--coco_path', default='/media/DATADISK/coco_datasets/swarm_poc',
                        type=str)
    ...
    parser.add_argument('--finetune', default='./weights/converted_deta_swin_o365_finetune.pth', help='finetune from checkpoint')
...
def main(args):
    ...
    data_loader_train = DataLoader(dataset_train, args.batch_size, shuffle=True,
    ...
    trainer.fit(model, train_dataloader=data_loader_train, val_dataloaders=data_loader_val)
...
if __name__ == "__main__":
    ...
    custom_args = '--with_box_refine --two_stage \
        ...
        --assign_first_stage --assign_second_stage \
        --epochs 5 --lr_drop 20 \
        --lr 5e-5 --lr_backbone 5e-6 --batch_size 16 \
        --backbone swin \
        --bigger'.split()
